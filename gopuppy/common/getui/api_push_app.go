...
func (this *PushAppResult) GetResult() string {
	return this.Result
}

//全推,http://docs.getui.com/getui/server/rest/push/#doc-title-2
func PushApp(param *PushAppParam) (*PushAppResult, error) {
	pushAppResult := &PushAppResult{}
	err := callGetuiApi("push_app", param, pushAppResult)
